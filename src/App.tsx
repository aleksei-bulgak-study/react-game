...
import { loadResultsFromStorage, loadSettingsFromStorage, storeResultsInStore, storeSettingsInStore } from './utils';
            ...
            <main className={className}>
                <Switch>
                    <Route
                        exact
                        path="/play"
                        component={() => <Layout.GamePage settings={settings} onResultChange={setResults} />}
                    />
                    <Route
                        exact
                        path="/settings"
